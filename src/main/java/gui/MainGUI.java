...
public class MainGUI extends JFrame {
    ...
    public MainGUI() {
        ...
        for (int i = 0; i < 5; i++)
            calendar.getTimetableSettings().getDates().add(date.addDays(i));

        calendar.getTimetableSettings().setStartTime(8*60);
        calendar.getTimetableSettings().setEndTime(20*60);

        calendar.getTimetableSettings().setItemOffset(2);
        ...
        springLayout.putConstraint(SpringLayout.WEST, comboBox, 5, SpringLayout.EAST, label);
        springLayout.putConstraint(SpringLayout.SOUTH, comboBox, -5, SpringLayout.NORTH, teachers);
